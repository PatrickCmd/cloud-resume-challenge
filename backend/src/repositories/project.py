...
class ProjectRepository(BaseRepository):
    ...
    def update(self, project_id: str, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        for key, value in data.items():
            if key in ['name', 'description', 'longDescription', 'tech', 'company', 'featured', 'githubUrl', 'liveUrl', 'imageUrl', 'updatedAt']:
    ...
    def publish(self, project_id: str) -> Optional[Dict[str, Any]]:
        """Publish project."""
    ...
    def unpublish(self, project_id: str) -> Optional[Dict[str, Any]]:
        """Unpublish project."""
        updated_at = datetime.now(timezone.utc).isoformat()
