...
class CertificationRepository(BaseRepository):
    ...
    def to_item(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        date_earned = data.get('dateEarned') or datetime.now(timezone.utc).isoformat()
    ...
    def get_by_id(self, cert_id: str) -> Optional[Dict[str, Any]]:
    ...
    def list_certifications(
        ...
        if status and not cert_type:
            ...
            if featured is not None:
                all_items = [item for item in all_items if item.get('Data', {}).get('featured') == featured]
    ...
    def update(self, cert_id: str, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        for key, value in data.items():
            if key in ['name', 'issuer', 'icon', 'type', 'featured', 'description', 'credentialUrl', 'dateEarned', 'updatedAt']:
    ...
    def publish(self, cert_id: str) -> Optional[Dict[str, Any]]:
    ...
    def unpublish(self, cert_id: str) -> Optional[Dict[str, Any]]:
