...
class TestListCertifications:
    ...
    def test_list_certifications_default(
        self,
        test_client,
        override_get_certification_repository,
        mock_cert_repo,
        sample_cert_list_response,
    ):
    ...
    def test_list_certifications_by_type(
        self,
        test_client,
        override_get_certification_repository,
        mock_cert_repo,
    ...
    def test_list_certifications_invalid_type(
        self, test_client, override_get_certification_repository, mock_cert_repo
    ):
...
class TestGetCertification:
    ...
    def test_get_published_certification(
        self,
        test_client,
        override_get_certification_repository,
        mock_cert_repo,
    ...
    def test_get_draft_certification_as_public(
        self,
        test_client,
        override_get_certification_repository,
        mock_cert_repo,
    ...
    def test_create_certification_success(
        ...
        with patch("src.dependencies.extract_user_from_token", return_value=mock_user_info):
            response = test_client.post(
                "/certifications", json=create_data, headers={"Authorization": "Bearer valid-token"}
            )
...
class TestDeleteCertification:
    ...
    def test_delete_certification_success(
        self, test_client, override_get_certification_repository, mock_cert_repo, mock_user_info
    ):
        ...
        with patch("src.dependencies.extract_user_from_token", return_value=mock_user_info):
            response = test_client.delete(
                "/certifications/test-cert-123", headers={"Authorization": "Bearer valid-token"}
            )
