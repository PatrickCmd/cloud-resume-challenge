...
class TestListBlogs:
    ...
    def test_list_blogs_default(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_list_response):
    ...
    def test_list_blogs_with_status_filter(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_list_response):
    ...
    def test_list_blogs_with_category_filter(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_list_response):
    ...
    def test_list_blogs_with_pagination(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_list_response):
    ...
    def test_list_blogs_invalid_status(self, test_client, override_get_blog_repository, mock_blog_repo):
...
class TestGetBlogPost:
    ...
    def test_get_published_blog_post(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_post):
    ...
    def test_get_draft_blog_post_as_public(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_post):
    ...
    def test_get_nonexistent_blog_post(self, test_client, override_get_blog_repository, mock_blog_repo):
...
class TestCreateBlogPost:
    ...
    def test_create_blog_post_success(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_post, mock_user_info):
    ...
    def test_create_blog_post_without_auth(self, test_client, override_get_blog_repository, mock_blog_repo):
    ...
    def test_create_blog_post_as_non_owner(self, test_client, override_get_blog_repository, mock_blog_repo, mock_visitor_user_info):
...
class TestUpdateBlogPost:
    ...
    def test_update_blog_post_success(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_post, mock_user_info):
    ...
    def test_update_nonexistent_blog_post(self, test_client, override_get_blog_repository, mock_blog_repo, mock_user_info):
    ...
    def test_update_blog_post_empty_data(self, test_client, override_get_blog_repository, mock_blog_repo, mock_user_info):
...
class TestDeleteBlogPost:
    ...
    def test_delete_blog_post_success(self, test_client, override_get_blog_repository, mock_blog_repo, mock_user_info):
    ...
    def test_delete_nonexistent_blog_post(self, test_client, override_get_blog_repository, mock_blog_repo, mock_user_info):
...
class TestPublishBlogPost:
    ...
    def test_publish_blog_post_success(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_post, mock_user_info):
        """Test publishing a draft blog post."""
        mock_blog_repo.publish.return_value = sample_blog_post

        with patch('src.dependencies.extract_user_from_token', return_value=mock_user_info):
            response = test_client.post(
                "/blogs/test-blog-123/publish",
                headers={"Authorization": "Bearer valid-token"}
            )
    ...
    def test_publish_nonexistent_blog_post(self, test_client, override_get_blog_repository, mock_blog_repo, mock_user_info):
        """Test publishing a non-existent blog post."""
        mock_blog_repo.publish.return_value = None

        with patch('src.dependencies.extract_user_from_token', return_value=mock_user_info):
            response = test_client.post(
                "/blogs/nonexistent-id/publish",
                headers={"Authorization": "Bearer valid-token"}
            )
...
class TestUnpublishBlogPost:
    ...
    def test_unpublish_blog_post_success(self, test_client, override_get_blog_repository, mock_blog_repo, sample_blog_post, mock_user_info):
