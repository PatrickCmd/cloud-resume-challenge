...
class TestTrackContentView:
    ...
    def test_track_blog_view(
        self, test_client, override_get_analytics_repository, mock_analytics_repo
    ):
    ...
    def test_track_certification_view(
        self, test_client, override_get_analytics_repository, mock_analytics_repo
    ):
    ...
    def test_track_invalid_content_type(
        self, test_client, override_get_analytics_repository, mock_analytics_repo
    ):
...
class TestGetContentViewCount:
    ...
    def test_get_view_count_invalid_type(
        self, test_client, override_get_analytics_repository, mock_analytics_repo
    ):
...
class TestGetTopContent:
    ...
    def test_get_top_content(
        self, test_client, override_get_analytics_repository, mock_analytics_repo, mock_user_info
    ):
        """Test getting top viewed content."""
        mock_analytics_repo.get_top_content.return_value = {
            "blogs": [{"contentId": "blog-1", "views": 500}, {"contentId": "blog-2", "views": 300}],
            "projects": [{"contentId": "proj-1", "views": 200}],
            "certifications": [],
        }

        with patch("src.dependencies.extract_user_from_token", return_value=mock_user_info):
            response = test_client.get(
                "/analytics/top-content?limit=5", headers={"Authorization": "Bearer valid-token"}
            )
    ...
    def test_get_top_content_without_auth(
        self, test_client, override_get_analytics_repository, mock_analytics_repo
    ):
...
class TestGetAnalyticsOverview:
    ...
    def test_get_analytics_overview(
        ...
        mock_analytics_repo.get_top_content.return_value = {
            "blogs": [{"contentId": "blog-1", "views": 500}],
            "projects": [],
            "certifications": [],
        }
        ...
        with patch("src.dependencies.extract_user_from_token", return_value=mock_user_info):
            response = test_client.get(
                "/analytics/overview?days=30", headers={"Authorization": "Bearer valid-token"}
            )
...
class TestGetPageAnalytics:
    ...
    def test_get_page_analytics_for_blogs(
        self, test_client, override_get_analytics_repository, mock_analytics_repo, mock_user_info
    ):
    ...
    def test_get_page_analytics_invalid_type(
        self, test_client, override_get_analytics_repository, mock_analytics_repo, mock_user_info
    ):
...
class TestGetBlogPostStats:
    ...
    def test_get_blog_post_stats(
        self,
        test_client,
        override_get_analytics_repository,
        mock_analytics_repo,
        mock_blog_repo,
        mock_user_info,
    ):
    ...
    def test_get_blog_post_stats_not_found(
        self,
        test_client,
        override_get_analytics_repository,
        mock_analytics_repo,
