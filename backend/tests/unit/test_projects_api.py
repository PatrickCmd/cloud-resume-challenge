...
class TestListProjects:
    ...
    def test_list_projects_default(self, test_client, override_get_project_repository, mock_project_repo, sample_project_list_response):
    ...
    def test_list_projects_featured_only(self, test_client, override_get_project_repository, mock_project_repo, sample_project_list_response):
    ...
    def test_list_projects_with_status_filter(self, test_client, override_get_project_repository, mock_project_repo, sample_project_list_response):
    ...
    def test_list_projects_invalid_status(self, test_client, override_get_project_repository, mock_project_repo):
...
class TestGetProject:
    ...
    def test_get_published_project(self, test_client, override_get_project_repository, mock_project_repo, sample_project):
    ...
    def test_get_draft_project_as_public(self, test_client, override_get_project_repository, mock_project_repo, sample_project):
    ...
    def test_get_nonexistent_project(self, test_client, override_get_project_repository, mock_project_repo):
...
class TestCreateProject:
    ...
    def test_create_project_success(self, test_client, override_get_project_repository, mock_project_repo, sample_project, mock_user_info):
    ...
    def test_create_project_without_auth(self, test_client, override_get_project_repository, mock_project_repo):
    ...
    def test_create_project_as_non_owner(self, test_client, override_get_project_repository, mock_project_repo, mock_visitor_user_info):
...
class TestUpdateProject:
    ...
    def test_update_project_success(self, test_client, override_get_project_repository, mock_project_repo, sample_project, mock_user_info):
    ...
    def test_update_nonexistent_project(self, test_client, override_get_project_repository, mock_project_repo, mock_user_info):
    ...
    def test_update_project_empty_data(self, test_client, override_get_project_repository, mock_project_repo, mock_user_info):
...
class TestDeleteProject:
    ...
    def test_delete_project_success(self, test_client, override_get_project_repository, mock_project_repo, mock_user_info):
    ...
    def test_delete_nonexistent_project(self, test_client, override_get_project_repository, mock_project_repo, mock_user_info):
...
class TestPublishProject:
    ...
    def test_publish_project_success(self, test_client, override_get_project_repository, mock_project_repo, sample_project, mock_user_info):
    ...
    def test_publish_nonexistent_project(self, test_client, override_get_project_repository, mock_project_repo, mock_user_info):
        """Test publishing a non-existent project."""
        mock_project_repo.publish.return_value = None

        with patch('src.dependencies.extract_user_from_token', return_value=mock_user_info):
            response = test_client.post(
                "/projects/nonexistent-id/publish",
                headers={"Authorization": "Bearer valid-token"}
            )
...
class TestUnpublishProject:
    ...
    def test_unpublish_project_success(self, test_client, override_get_project_repository, mock_project_repo, sample_project, mock_user_info):
